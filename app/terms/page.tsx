  ...
  return (
    <div className="container mx-auto py-16 px-4">
      ...
      <div className="prose prose-lg max-w-4xl mx-auto">
        ...
        <section className="mb-8">
          <h2 className="text-2xl font-bold text-primary mb-4">2. General Terms</h2>
          <p>
          ...
          <h3 className="text-xl font-semibold text-rose-600 dark:text-rose-400 mt-4 mb-2">2.1 Appointments</h3>
          <p>
          ...
          <h3 className="text-xl font-semibold text-rose-600 dark:text-rose-400 mt-4 mb-2">2.2 Payment</h3>
          <p>
          ...
          <h3 className="text-xl font-semibold text-rose-600 dark:text-rose-400 mt-4 mb-2">2.3 Refunds</h3>
          <p>
        ...
        <section className="mb-8">
          <h2 className="text-2xl font-bold text-primary mb-4">3. Voucher & Coupon Terms</h2>
          <h3 className="text-xl font-semibold text-rose-600 dark:text-rose-400 mt-4 mb-2">3.1 Gift Vouchers</h3>
          <p>
          ...
          <h3 className="text-xl font-semibold text-rose-600 dark:text-rose-400 mt-4 mb-2">3.2 Promotional Coupons</h3>
          <p>
          ...
          <h3 className="text-xl font-semibold text-rose-600 dark:text-rose-400 mt-4 mb-2">3.3 Referral Program</h3>
          <p>
        ...
        <section className="mb-8">
          <h2 className="text-2xl font-bold text-primary mb-4">4. Premium Beauty Card Terms</h2>
          <h3 className="text-xl font-semibold text-rose-600 dark:text-rose-400 mt-4 mb-2">4.1 Membership</h3>
          <p>
          ...
          <h3 className="text-xl font-semibold text-rose-600 dark:text-rose-400 mt-4 mb-2">4.2 Benefits</h3>
          <p>
          ...
          <h3 className="text-xl font-semibold text-rose-600 dark:text-rose-400 mt-4 mb-2">4.3 Renewal</h3>
          <p>
        ...
        <section className="mb-8">
          <h2 className="text-2xl font-bold text-primary mb-4">5. Health and Safety</h2>
          <p>
        ...
        <section className="mb-8">
          <h2 className="text-2xl font-bold text-primary mb-4">8. Liability</h2>
          <p>
        ...
        <section className="mb-8">
          <h2 className="text-2xl font-bold text-primary mb-4">9. Service-Specific Terms</h2>
          <h3 className="text-xl font-semibold text-rose-600 dark:text-rose-400 mt-4 mb-2">9.1 Bridal Services</h3>
          <p>
          ...
          <h3 className="text-xl font-semibold text-rose-600 dark:text-rose-400 mt-4 mb-2">9.2 Hair Services</h3>
          <p>
          ...
          <h3 className="text-xl font-semibold text-rose-600 dark:text-rose-400 mt-4 mb-2">9.3 Skincare Services</h3>
          <p>
        ...
        <section className="mb-8">
          <h2 className="text-2xl font-bold text-primary mb-4">10. Changes to Terms and Conditions</h2>
          <p>
